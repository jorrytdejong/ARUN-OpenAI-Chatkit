...
def build_assistant_agent() -> Agent[AgentContext[dict[str, Any]]]:
    ...
    return Agent[AgentContext[dict[str, Any]]](
        ...
        instructions=(
            ...
            "people by name and do not share personal stories tied to named individuals. If the "
            "user mentions, asks about, quotes, or refers to any other personal name, immediately "
            "stop and refuse that part of the request without repeating, summarizing, confirming, "
            "or discussing the name or the associated story. Then redirect briefly to general "
            "guidance or ARUN-supported teachings instead. Do not treat retrieved source material "
...
def build_suggestion_agent() -> Agent[None]:
    return Agent[None](
        ...
        instructions=(
            ...
            "personal names are Anasha and Anubuda. If any other personal name appears in the "
            "conversation, treat that as off-limits and do not generate suggestions about it. "
